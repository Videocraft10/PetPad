...
void setup() {
  Serial.begin(115200);
  delay(10);
  Serial.println("PetPad: starting");
  ...
  Serial.print("I2C pins SDA="); Serial.print(SDA_PIN);
  ...
  Serial.print("Initial pet: hunger="); Serial.print(pet.hunger);
  Serial.print(" love="); Serial.print(pet.love);
  Serial.print(" energy="); Serial.print(pet.energy);
  Serial.print(" life="); Serial.println(pet.life);
}
...
void updatePet() {
  if (millis() - lastUpdate > 5000) {
    ...
    if (pet.hunger < 30 || pet.energy < 30 || pet.love < 30) {
      pet.life -= 5;
    } else if (pet.hunger > 150 || pet.energy > 150) {
      pet.life -= 5;
